...
<div class="page-header">
	<h1>
		<span class="text-ligth-gray">Alunos</span>
	</h1>
</div>
...
<div class="panel-heading">
	<span class="panel-title">Novo Aluno</span>
</div>
...
<div class="panel-footer text-center">
	<?php
	echo form_hidden(array("tipoUsuarioInserir" => 3));
...
<div class="table-primary">
	<div class="table-header">
		<div class="table-caption">Alunos Cadastrados</div>
	</div>
