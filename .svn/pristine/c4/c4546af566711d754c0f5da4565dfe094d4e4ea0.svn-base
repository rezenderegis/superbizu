...
<div class="page-header">
	<h1>
		<span class="text-ligth-gray">Minhas Resoluções</span>
	</h1>
</div>
...
<div class="table-primary">
	<div class="table-header">
		<div class="table-caption">Listas Resolvidas</div>
	</div>
	...
	<tr>
				...
				<td class="gacesso">
				<?=anchor("lista/formularioVerificarResolucao/{$lista['IDLISTAQUESTOES']}/{$lista['ID_GRUPO_QUESTAO']}", '<i class="navbar-icon fa fa-bars icon"></i><span')?>
				</td>
				<!-- 
				<td>
