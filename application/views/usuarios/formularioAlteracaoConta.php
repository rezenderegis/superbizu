...
<?=form_open("usuarios/alterarConta", array('id' => 'novousuario'))?>
...
<div class="panel">
		  ...
		  <div class="row form-group"
		 	<label class="col-sm-4 control-label"></label>
		 			...
		 			if ($usuario_edicao['nome_foto_sistema']) {
		 				$imagem = "uploads/imagens_contas/".$usuario_edicao['nome_foto_sistema'];
		...
		echo form_hidden(array("id_usuario" => $usuario_edicao['id']));
	?>
