...
<div class="panel-body">
	<div class="row form-group">
		<label class="col-sm-4 control-label">Informe o Nome da Lista</label>
		<div class="col-sm-4">
...
<div class="buttons-with-margins">
	<?=anchor('lista/criarLista/true', 'Mostrar Cadastradas SuperBizu', array("class" => "btn btn-primary"))?>
...
<div class="table-primary">
	<div class="table-header">
		<div class="table-caption">Questões Disponíveis para Inclusão na Lista	</div>
	</div>
		
		
		<table class="table table-striped bordered">
		
		<thead><tr><th><b></b></th><th><b>ID</b></th><th><b>Matéria</b></th><th><b>Assunto</b></th><th><b>Questão</b></th><th><b>Itens</b></th><th>Ver Img</th></tr>
		</thead>
		<tbody>
			<?php 
